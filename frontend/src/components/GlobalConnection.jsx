    ...
    <section className="relative overflow-hidden bg-[#F5F7FA] py-24 sm:py-28 lg:py-32">
      ...
      <div className="arkan-container relative">
        ...
        <div className="grid items-end gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="lg:pb-2">
            ...
            <p className="max-w-xl text-base leading-7 text-slate-600 sm:text-lg">
              Arkan Trade Cargo & Freight Solutions connects
              businesses to global markets through dependable
              freight, customs and cargo solutions.
            </p>
        ...
        <div className="mt-16 grid gap-5 lg:grid-cols-12">
          ...
          {/* LARGE IMAGE / VISUAL */}
          <div className="group relative min-h-[420px] overflow-hidden rounded-2xl bg-[#071A2F] lg:col-span-7">

            <div
              className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105"
              style={{
                backgroundImage:
                  "url('https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?auto=format&fit=crop&w=1600&q=85')",
              }}
            />

            {/* Overlay */}
            <div className="absolute inset-0 bg-gradient-to-t from-[#04111F] via-[#071A2F]/30 to-transparent" />

            {/* Label */}
            <div className="absolute left-6 top-6 flex items-center gap-2 rounded-full border border-white/20 bg-[#04111F]/50 px-4 py-2 backdrop-blur-md">
              ...
              <div className="flex items-end justify-between gap-6">
                ...
                <div>
                  ...
                  <h3 className="max-w-lg text-2xl font-bold leading-tight text-white sm:text-3xl">
                    Every shipment deserves a reliable journey.
                  </h3>

                </div>

                <div className="hidden h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#C9A227] text-[#071A2F] sm:flex">
                  <MoveUpRight size={20} />
                </div>
          ...
          <div className="grid gap-5 lg:col-span-5">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-[#071A2F] p-7 sm:p-8">
              ...
              <div className="absolute right-0 top-0 h-32 w-32 translate-x-1/3 -translate-y-1/3 rounded-full border border-[#C9A227]/20" />
              ...
              <p className="relative mt-3 max-w-md text-sm leading-6 text-white/60">
                Supporting international trade by connecting
                Kenyan businesses with markets across Africa,
                Europe, the Middle East and beyond.
              </p>

              <div className="mt-7 flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-[#D4AF37]">
                Kenya → Worldwide
              </div>
            ...
            <div className="rounded-2xl bg-white p-7 shadow-sm ring-1 ring-slate-200 sm:p-8">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Professional logistics coordination designed
                around the requirements of your cargo and
                destination.
              </p>
          ...
          <div className="flex items-center gap-5 p-6 sm:p-7">
            ...
            <div>
              ...
              <p className="mt-1 text-xs leading-5 text-slate-500">
                Solutions designed around your timelines.
              </p>
            </div>
          ...
          <div className="border-t border-slate-200 p-6 sm:border-l sm:border-t-0 sm:p-7">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500">
                  Supporting global cargo movement.
                </p>
              </div>
          ...
          <div className="border-t border-slate-200 p-6 sm:border-l sm:border-t-0 sm:p-7">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500">
                  Built around your shipment requirements.
                </p>
              </div>
